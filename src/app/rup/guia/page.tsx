...
export default function RupGuidePage({
  ...
  const unlockedByToken =
    !!email && !!token && verifyUnlockToken(email, "rup", token);
            ...
            <>
              ...
              <div className="mt-14 rounded-lg border border-orange/30 bg-surface-raised p-6">
                ...
                <p className="mt-2 text-sm text-beige/70">
                  En Fromus te decimos en un minuto si estás habilitado o no para
                  una oportunidad, y te armamos la propuesta. Conócenos.
                </p>
                <a
